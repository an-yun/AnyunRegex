...
namespace anyun_regex
{
	...
	void test_nfa_match()
	{
		...
		nfa_test.set_pattern("a|b");
		nfa_test.add_testcase("a");
		nfa_test.add_testcase("b");
		nfa_test.add_testcase("ab");
		nfa_test.add_testcase("aaa");
		nfa_test.add_testcase("bbbb");
		nfa_test.add_testcase("134erq");
		nfa_test.add_testcase("abceefaeq");
		nfa_test.add_testcase("ewqtefadsfqrte");
		nfa_test.add_testcase("ewrertrtweryrrety4");
		nfa_test.add_testcase("$^(4ad)(^(03431)))923");
		nfa_test.test_match();

		nfa_test.set_pattern("a1|2bc");
		nfa_test.add_testcase("a");
		nfa_test.add_testcase("b");
		nfa_test.add_testcase("2bc");
		nfa_test.add_testcase("a1aa");
		nfa_test.add_testcase("a1bca");
		nfa_test.add_testcase("ba2bcbb");
		nfa_test.add_testcase("134erq");
		nfa_test.add_testcase("abcea1bcaefaeq");
		nfa_test.add_testcase("ewqtefadsfqrte");
		nfa_test.add_testcase("ewrertrtweryrrety4");
		nfa_test.add_testcase("$^(4ad)(^(03431");
		nfa_test.add_testcase("a111bbbbcc$^cca_)&");
		nfa_test.add_testcase("b1#a2^22a2bcbbbcbb)))923");
		nfa_test.add_testcase("C++ Is Designed by	Bjarne Stroustrup");
		nfa_test.add_testcase("can you find me is a1|2bc match this a12bc ro match this a1bc");
		nfa_test.test_match();

		nfa_test.set_pattern("am|is|are");
		nfa_test.add_testcase("are you ok?");
		nfa_test.add_testcase("I am fine!");
		nfa_test.add_testcase("thank you.");
		nfa_test.add_testcase("who is he?");
		nfa_test.add_testcase("can the regex engine find me aa aa aa ia sr s  ar aa a aam ,ok you get it");
		nfa_test.add_testcase("");
		nfa_test.test_match();

		nfa_test.set_pattern("he(r|ll)o");
		nfa_test.add_testcase("hello");
		nfa_test.add_testcase("hero");
		nfa_test.add_testcase("are you ok?");
		nfa_test.add_testcase("I am fine!");
		nfa_test.add_testcase("can the regex engine find me aa aa aa ia sr s  ar aa a aam ,ok you get it wrong");
		nfa_test.test_match();
